        ...
        <div class="card h-md-100">
            <div class="card-header pb-0 mb-1 border-0">
                <h5 class="mb-0 mt-1 fw-bold text-center">
                    Washing machine
                    <span class="badge rounded-pill bg-info text-dark">ID: <?php echo $DATA["ID"]; ?></span>
                </h5>
            </div>
            <div class="card-body p-3">
                <div class="row align-items-center">
                    <div class="col">
                        <p class="font-sans-serif lh-1 mb-1 fs-3" id="time-remaining-ID<?php echo $DATA["ID"]; ?>"
                            machine-id="<?php echo $DATA["ID"]; ?>">Loading...
                        </p>
                        <span class="badge rounded-pill bg-success fs-13 text-blink">Time
                            remaining</span>
                    </div>
                    <div class="col-auto ps-0">
                        <div class="d-flex flex-nowrap align-items-center">
                            <h4 class="font-sans-serif fs-3 fw-500" id="status-machineID<?php echo $DATA["ID"]; ?>"
                                machine-id="<?php echo $DATA["ID"]; ?>">Available
                            </h4>
                            <div class="px-2 shaking">
